...
export const MainCanvas: React.FC<MainCanvasProps> = ({ currentSlide, isPresentationMode, onExitPresentation }) => {
  return (
    <div className={`flex-1 overflow-hidden relative ${isPresentationMode ? 'bg-black flex items-center justify-center fixed inset-0 z-50' : 'bg-[#1a1a1a] p-8 flex items-center justify-center'}`}>
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className={`bg-white shadow-2xl relative flex flex-col items-center justify-center ${isPresentationMode
