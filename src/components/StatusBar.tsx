...
export const StatusBar: React.FC<StatusBarProps> = ({ currentSlide, totalSlides, onStartPresentation }) => {
  return (
    <div className="h-6 bg-[#1f1f1f] border-t border-[#333] flex items-center justify-between px-3 text-[11px] text-[#e1e1e1] select-none z-20">
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2 text-[#e1e1e1]">
